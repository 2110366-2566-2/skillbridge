                                ...
                                <div className="flex flex-col">
                                    ...
                                    <div className="flex flex-col md:flex-row md:justify-between md:gap-2">
                                        <div className="flex flex-col md:w-full">
                                            ...
                                            <NumberInput value={filtered.minPrice} name="minPrice" placeholder="0" onChange={handleChange} />
                                        </div>
                                        <div className="flex flex-col md:w-full">
                                            <div className="font-medium text-[16px] text-slate-800 mt-3 mb-1 md:mt-0">
                                                ราคาสูงสุด
                                            </div>
                                            <NumberInput value={filtered.maxPrice} name="maxPrice" placeholder="ราคาสูงสุด" onChange={handleChange} />
                                        </div>
                                    </div>
